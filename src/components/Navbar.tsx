          ...
          <div className="relative flex items-center bg-slate-900/90 p-1 rounded-xl border border-slate-700/80 shadow-inner">
            <div className="flex items-center gap-1">
              ...
              <button
                ...
                title="AI Ultra 5x (進階效能)：全核心 gemini-3.7-flash 深度推理"
              >
            ...
            {showTierInfo && (
              <div className="absolute right-0 top-full mt-2 w-80 p-3.5 rounded-xl bg-slate-900 border border-slate-700 shadow-2xl z-50 text-xs text-slate-300 space-y-2.5">
                ...
                <div className="space-y-1.5 leading-relaxed text-[11px]">
                  <p>
                    <strong className="text-emerald-400">🟢 AI Pro (Web UI 最佳化 - 推薦)</strong>：專為使用 Google AI 訂閱與免費 API 打造，對話使用極速 <code className="text-cyan-300">gemini-3.5-flash-lite</code>，圖片使用 <code className="text-purple-300">gemini-2.5-flash</code>，核心生成使用 <code className="text-amber-300">gemini-3.7-flash</code>，零超額且具備自動降級保護。
                  </p>
                  <p>
